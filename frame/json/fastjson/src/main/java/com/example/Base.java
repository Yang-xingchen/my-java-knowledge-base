...
public class Base {
    ...
    public void primitive () {
        Assertions.assertEquals(1, JSON.parseObject("1", int.class));
        Assertions.assertEquals(1.23, JSON.parseObject("1.23", double.class));
        Assertions.assertTrue(JSON.parseObject("true", boolean.class));
        Assertions.assertThrows(JSONException.class, () -> JSON.parseObject("a", char.class));
        Assertions.assertThrows(JSONException.class, () -> JSON.parseObject("a", String.class));
        Assertions.assertNull(JSON.parseObject("null", Object.class));
        Assertions.assertNull(JSON.parseObject((String) null, Object.class));
    }
    ...
    public void entry() {
        ...
        BaseEntry entry1 = JSON.parseObject(json, BaseEntry.class);
    ...
    public void list() {
        ...
        String sListJson = JSON.toJSONString(strings);
        // ["str1","str2"]
        System.out.println(sListJson);
        List<String> strings1 = JSON.parseObject(sListJson, new TypeReference<>() {});
        ...
        String eListJson = JSON.toJSONString(entries);
        ...
        List<BaseEntry> entries1 = JSON.parseObject(eListJson, new TypeReference<>() {});
    ...
    public void map() {
        ...
        String sMapJson = JSON.toJSONString(stringMap);
        // {"int":1,"double":1.23,"arr":["str","str2"],"obj":{"b":false,"i":0,"pub":0,"str":"str","value":"str0"},"str":"v1"}
        System.out.println(sMapJson);
        Map<String, Object> stringMap1 = JSON.parseObject(sMapJson, new TypeReference<>() {});
    ...
    public void constructor() {
        ...
        String json = JSON.toJSONString(entry);
        System.out.println(json);
        ConstructorEntry entry1 = JSON.parseObject(json, ConstructorEntry.class);
