...
public class Annotation {
    ...
    @Test
    public void read() {
        BaseEntry entry = JSONObject.parseObject("{\"s2\":\"s2\",\"str1\":\"s1\"}", BaseEntry.class);
        Assertions.assertEquals("s1", entry.s1);
        Assertions.assertEquals("s2", entry.s2);
        entry = JSONObject.parseObject("{\"str2\":\"s2\",\"str1\":\"s1\"}", BaseEntry.class);
        Assertions.assertEquals("s1", entry.s1);
        Assertions.assertEquals("s2", entry.s2);
    }
...
//    @Test
//    public void build() {
//        BuildEntry entry = JSONObject.parseObject("{\"str2\":\"s2\",\"str1\":\"s1\"}", BuildEntry.class);
...
//        private String s2;
//
////        @JSONField(alternateNames = {"str1", "s1"})
//        public EntryBuild whitStr1(String s1) {
//            this.str1 = s1;
//            return this;
//        }
//
////        @JSONField(alternateNames = {"str2", "s2"})
//        public EntryBuild whitS2(String s2) {
//            this.s2 = s2;
//            return this;
//        }
//
...
//        StaticEntry entry = JSONObject.parseObject("{\"str2\":\"s2\",\"str1\":\"s1\"}", StaticEntry.class);
//        Assertions.assertEquals("s1", entry.str1);
//        Assertions.assertEquals("s2", entry.str2);
//    }
//
...
//        }
//
//        public static StaticEntry create(String s1, String s2) {
